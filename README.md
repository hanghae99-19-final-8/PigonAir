...
| 이름 | 담당 역할 | Github |
|----------|----------|----------|
| 이성욱(팀장) | - JPA를 사용하여 pagination query 구현 <br> - 캐싱 기능 구현 → 이후 Elasticache:Redis 로 이식 <br> - db indexing 기능 구현 <br> - AWS Auto Scaling Group을 이용하여 가용성 확보 작업 <br> - RDS MySQL Connection pool 튜닝 <br> - AWS ALB를 이용하여 가용성 확보 작업 <br> - AWS Auto Scaling Group을 이용하여 가용성 확보 작업  | [Link](https://github.com/gbk1414)|
...
| 송유하 |  | |
| 신수현 | - 항공권 예약 구현 <br> - ResponseEntity를 사용하여 컨트롤러 응답형식 통일 <br> - 전반적인 예외처리 진행 <br> - @Async와 RabbitMQ를 이용해 결제 후 처리 비동기화 진행  <br> - 예약 내역 관련 N+1문제 해결  <br> - @EntityGraph를 이용한 LazyInitializationException 문제 해결 <br> - 비관적 락을 통한 동시성 문제 해결  <br> - Jmeter를 통한 성능 테스트 진행 | [Link](https://github.com/suhyun9764)|
